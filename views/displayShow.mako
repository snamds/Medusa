                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        % if not app.DISPLAY_ALL_SEASONS:
                            <button id="showseason-${epResult['season']}" type="button" class="btn top-5 bottom-5 pull-right" data-toggle="collapse" data-target="#collapseSeason-${epResult['season']}">${("Show", "Hide")[cur_season == -1]} Episodes</button>
                        % endif
                    </div>
                </div>
                <div class="row">
